...
const CanvasComponent: React.FC<CanvasComponentProps> = ({
	...
	const draw = (
		...
		const elementWidthPercent = 1; // Width of each element as a percentage of total width
		...
		for (let i = 0; i < 25; i++) {
			...
			ctx.rotate(rotation);
			ctx.fillStyle = "white";
			ctx.fillRect(-elementSize / 2, -elementSize / 2, 60, 1); // Centered at the element's position
			ctx.restore();
